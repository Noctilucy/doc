                  ...
                  <tbody>
                    ...
                    foreach ($data_penjualan as $penjualan) {
                      ...
                      <tr>
                        ...
                        <!-- <td>Status</td> -->
                        <td>
                          <a href = "<?=base_url('penjualan/detail/'.$penjualan->id);?>" class = "btn btn-info">Detail</a>
                          <button class ="btn btn-danger btn-delete" data-id="<?= $penjualan->id?>"><i class="fas fa-trash"></i></button>
                        </td>
                      </tr>
                      <?php }?>
                  </tbody>
