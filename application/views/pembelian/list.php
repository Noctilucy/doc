                  ...
                  <tbody>
                    ...
                    foreach ($data_pembelian as $pembelian) {?>
                      <tr>
                        ...
                        <!-- <td>Status</td> -->
                        <td>
                          <a href = "<?=base_url('pembelian/detail/'.$pembelian->id);?>" class = "btn btn-info">Detail</a>
                          <button class ="btn btn-danger btn-delete" data-id="<?= $pembelian->id?>"><i class="fas fa-trash"></i></button>
                        </td>
                      </tr>
                      <?php }?>
                  </tbody>
